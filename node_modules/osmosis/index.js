...
import Command, { prototype } from '../lib/Command.js';
import Queue from '../lib/Queue.js';
import request from '../lib/Request.js';
import libxml, { parseHtml, memoryUsage as _memoryUsage, nodeCount, Document, Element, css2xpath } from 'libxmljs-dom';
var instanceId = 0;
var memoryUsage = 0;
var cachedSelectors = {};
var toMB = function (size, num) {
    return (size / 1024 / 1024).toFixed(num || 2) + 'Mb';
};
var extend = function (object, donor) {
...
Osmosis.prototype.parse = function (data, opts) {
    ...
    var document = parseHtml(data, opts);
...
Document.prototype.find = function (selector, cache) {
...
Element.prototype.find = function (selector) {
    if (selector.charAt(1) === '/' ||
        ...
        cachedSelectors[selector] = css2xpath(selector);
    }
